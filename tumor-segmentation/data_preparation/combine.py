...
image_folders = ['./tumor-segmentation/data/resized_imgs', './tumor-segmentation/data/resized_synthetic_imgs']
mask_folders = ['./tumor-segmentation/data/resized_labels', './tumor-segmentation/data/resized_synthetic_masks']
merged_image_folder = './tumor-segmentation/data/all_images'
merged_mask_folder = './tumor-segmentation/data/all_masks'
